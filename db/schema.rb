...
ActiveRecord::Schema.define(version: 20170208170110) do
  ...
  create_table "mercado_pago_notifications", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "topic"
